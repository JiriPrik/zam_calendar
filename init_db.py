...
from app.models import User, Role, LeaveType, Holiday, AppSettings
...
def init_db():
    ...
    with app.app_context():
        ...
        if Role.query.count() == 0:
            ...
            manager_role = Role(name='Manager', description='Manažer týmu')
            employee_role = Role(name='Employee', description='Zaměstnanec')
        ...
        # Kontrola, zda již existuje nastavení aplikace
        if AppSettings.query.count() == 0:
            print("Vytvářím nastavení aplikace...")
